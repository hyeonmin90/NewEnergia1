...
<title>Angle/Time(Stable/Unstable)</title>
...
double p=((a*dp)/(2*h*Math.pow(wn,2)));
double q=-((a*dp)/(2*h*Math.pow(wn,2)))/Math.sqrt(1-Math.pow(s,2));
double l=-s*(wn);
double k=a+p;
double pp=Math.acos(s);
%>
<div class="box-body">
...
wd=<%=wd %>
pp=<%=pp %>
expr=k+'+'+q+'*cos('+l+'*t+x)*sin('+wd+'*t+x+'+pp+')+'+q+'*sin('+l+'*t+x)*sin('+wd+'*t+x+'+pp+')',
	    scope = { 
			x: 0,
			t: 0
			},
...
function calculation() {
	  ...
	  t=d.getTime();
	  frm.rtcInput.value=k+q*Math.cos(l*t)*Math.sin(wd*t+pp)+q*Math.sin(l*t)*Math.sin(wd*t+pp);
	  max=Math.max(k+q*Math.cos(l*(t))*Math.sin(wd*(t)+pp)+q*Math.sin(l*(t))*Math.sin(wd*(t)+pp),
			  k+q*Math.cos(l*(t-0.06))*Math.sin(wd*(t-0.06)+pp)+q*Math.sin(l*(t-0.06))*Math.sin(wd*(t-0.06)+pp),
			  k+q*Math.cos(l*(t-0.12))*Math.sin(wd*(t-0.12)+pp)+q*Math.sin(l*(t-0.12))*Math.sin(wd*(t-0.12)+pp),
			  k+q*Math.cos(l*(t-0.18))*Math.sin(wd*(t-0.18)+pp)+q*Math.sin(l*(t-0.18))*Math.sin(wd*(t-0.18)+pp),
			  k+q*Math.cos(l*(t-0.24))*Math.sin(wd*(t-0.24)+pp)+q*Math.sin(l*(t-0.24))*Math.sin(wd*(t-0.24)+pp),
			  k+q*Math.cos(l*(t-0.3))*Math.sin(wd*(t-0.3)+pp)+q*Math.sin(l*(t-0.3))*Math.sin(wd*(t-0.3)+pp),
			  k+q*Math.cos(l*(t-0.36))*Math.sin(wd*(t-0.36)+pp)+q*Math.sin(l*(t-0.36))*Math.sin(wd*(t-0.36)+pp),
			  k+q*Math.cos(l*(t-0.42))*Math.sin(wd*(t-0.42)+pp)+q*Math.sin(l*(t-0.42))*Math.sin(wd*(t-0.42)+pp),
			  k+q*Math.cos(l*(t-0.48))*Math.sin(wd*(t-0.48)+pp)+q*Math.sin(l*(t-0.48))*Math.sin(wd*(t-0.48)+pp),
			  k+q*Math.cos(l*(t-0.54))*Math.sin(wd*(t-0.54)+pp)+q*Math.sin(l*(t-0.54))*Math.sin(wd*(t-0.54)+pp),
			  k+q*Math.cos(l*(t-0.6))*Math.sin(wd*(t-0.6)+pp)+q*Math.sin(l*(t-0.6))*Math.sin(wd*(t-0.6)+pp),
			  k+q*Math.cos(l*(t-0.66))*Math.sin(wd*(t-0.66)+pp)+q*Math.sin(l*(t-0.66))*Math.sin(wd*(t-0.66)+pp),
			  k+q*Math.cos(l*(t-0.72))*Math.sin(wd*(t-0.72)+pp)+q*Math.sin(l*(t-0.72))*Math.sin(wd*(t-0.72)+pp),
			  k+q*Math.cos(l*(t-0.78))*Math.sin(wd*(t-0.78)+pp)+q*Math.sin(l*(t-0.78))*Math.sin(wd*(t-0.78)+pp),
			  k+q*Math.cos(l*(t-0.84))*Math.sin(wd*(t-0.84)+pp)+q*Math.sin(l*(t-0.84))*Math.sin(wd*(t-0.84)+pp),
			  k+q*Math.cos(l*(t-0.9))*Math.sin(wd*(t-0.9)+pp)+q*Math.sin(l*(t-0.9)+pp)*Math.sin(wd*(t-0.9)+pp),
			  k+q*Math.cos(l*(t-0.96))*Math.sin(wd*(t-0.96)+pp)+q*Math.sin(l*(t-0.96))*Math.sin(wd*(t-0.96)+pp),
			  k+q*Math.cos(l*(t-1))*Math.sin(wd*(t-1)+pp)+q*Math.sin(l*(t-1))*Math.sin(wd*(t-1)+pp)
	  ); 
